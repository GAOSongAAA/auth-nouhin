...
public class MyBatisConfig {
    ...
    public SqlSessionFactory sqlSessionFactory(DataSource dataSource) {
        try {
            ...
            // Mapper XMLファイルの場所を設定
            bean.setMapperLocations(
                new PathMatchingResourcePatternResolver().getResources("classpath*:/com/collaboportal/common/jwt/repository/*.xml")
            );
            // エイリアスのパッケージを設定
            bean.setTypeAliasesPackage("com.collaboportal.common.jwt.entity");
