 ...
 * 認証・認可設定を行うストラテジークラス
 */
public class AuthorizationStrategy implements SecurityConfigStrategy{

    // ロガー
    Logger logger = LoggerFactory.getLogger(AuthorizationStrategy.class);
     ...
     */
    public AuthorizationStrategy(String noAuthMode, String envFlag, String[] noAuthUrls) {
