...
public class JwtConstants {
    ...
    // トークン検証タイプ
    public static final String VALIDATE_TYPE_ISSUER_OAUTH2 = "issuer-validator";
    public static final String VALIDATE_TYPE_DATABASE_DATABASE = "database_issuer-validator";
